...
public class JsonHelper {
    ...
    private abstract class Action {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof JsonHelper.Action)) {
                return false;
            }
            JsonHelper.Action o = (JsonHelper.Action) obj;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof JsonHelper)) {
            return false;
        }
        JsonHelper o = (JsonHelper) obj;
        return fListener.equals(o.fListener);
    }
